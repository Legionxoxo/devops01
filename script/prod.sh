...
# Production deployment script for devops01 App
# This script starts the application in production mode with Neon Cloud Database

echo "🚀 Starting devops01 App in Production Mode"
echo "==============================================="
...
echo "   Logs: docker logs devops01-app-prod"
echo ""
echo "Useful commands:"
echo "   View logs: docker logs -f devops01-app-prod"
